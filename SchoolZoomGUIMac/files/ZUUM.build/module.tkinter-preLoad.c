...
static void createModuleConstants(void) {
    const_str_digest_30726611e59fa5fa6b5721deb8c88bbb = UNSTREAM_STRING_ASCII(&constant_bin[ 6920 ], 24, 0);
    const_str_plain_environ = UNSTREAM_STRING_ASCII(&constant_bin[ 5205 ], 7, 1);
    const_tuple_str_plain_TCL_LIBRARY_none_tuple = PyTuple_New(2);
    const_str_plain_TCL_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 6944 ], 11, 1);
    ...
    const_str_digest_0492865e46cd96ee17148a12c234a543 = UNSTREAM_STRING_ASCII(&constant_bin[ 6955 ], 19, 0);
    const_str_plain_tk = UNSTREAM_STRING_ASCII(&constant_bin[ 957 ], 2, 1);
    const_str_plain_tcl = UNSTREAM_STRING_ASCII(&constant_bin[ 2491 ], 3, 1);
    const_str_plain_TK_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 6974 ], 10, 1);
    const_str_plain___nuitka_binary_dir = UNSTREAM_STRING_ASCII(&constant_bin[ 2099 ], 19, 1);
